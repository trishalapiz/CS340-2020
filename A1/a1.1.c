...
/* a function that enables quick_sort to be called without changing quick_sort's definition */
...
int main(int argc, char *argv[]) {
    ...
    int pivot_pos = split_on_pivot(start_block); // FIND INITIAL PIVOT

    struct block left_side, right_side; // partition data by initial pivot
    ...
    // create a new thread to sort the left side
